    ...
    <Popover className="DropdownTravelers relative flex">
      {({ open, close }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute z-40 ml-40 w-screen max-w-3xl px-4 top-full transform -translate-x-1/2 left-1/2 sm:px-0">
              <div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="relative grid grid-cols-3 gap-7 bg-white dark:bg-neutral-800 p-7 ">
